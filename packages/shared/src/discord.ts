...
export const guildsJoin = (guildId: string, userId: string, userAccessToken: string) =>
  axios.put(
    `${base}/guilds/${guildId}/members/${userId}`,
    { access_token: userAccessToken },
    { headers: { Authorization: `Bot ${process.env.DISCORD_TOKEN}` }, validateStatus: () => true }
  );
